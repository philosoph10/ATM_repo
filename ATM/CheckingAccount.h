...
public:
    ...
    // excessReceiver should equal nullptr in that case
    CheckingAccount(const QString& number, const QString& pincode, const QString& phone,
                    double initBalance, double maxBalance=0, const QString& excessReceiver="");
